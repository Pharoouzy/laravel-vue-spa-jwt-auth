    ...
    login: function login() {
      ...
      this.$auth.login({
        ...
        error: function error(res) {
          app.error = true; // alert(res.response.data.msg)
        },
        rememberMe: true,
        redirect: '/dashboard',
        fetchUser: true
...
var render = function() {
  ...
  return _c("div", { staticClass: "panel panel-default m-t-25" }, [
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("ul", [
      ...
      _vm._v(" "),
      _c("li", [_vm._v("Email: " + _vm._s(_vm.$auth.user().email))]),
      _vm._v(" "),
      _c("li", [_vm._v("Token: " + _vm._s(this.$auth.user().token))])
    ])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Laravel Vue SPA Authentication")])
}
var staticRenderFns = []
render._withStripped = true
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h2", [_vm._v("404 - Page Not Found")])
}
var staticRenderFns = []
render._withStripped = true
...
_App_vue__WEBPACK_IMPORTED_MODULE_2__["default"].router = vue__WEBPACK_IMPORTED_MODULE_0___default.a.router;
new vue__WEBPACK_IMPORTED_MODULE_0___default.a(_App_vue__WEBPACK_IMPORTED_MODULE_2__["default"]).$mount('#app'); // new Vue({
//     el: '#app',
//     router: router,
//     render: app => app(App)
// })
